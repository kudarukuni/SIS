					<form action="teacher_signup.php" method="POST" class="form-signin" onsubmit="checkfields()" id="signin_teacher">
			...
			<script>
				...
				{
					if (document.getElementById("firstname").value == "" || document.getElementById("lastname").value == "" || document.getElementById("password").value == "" || document.getElementById("cpassword").value == "" || document.getElementById("department_id").value == "" || document.getElementById("username_id").value == "")
					{
